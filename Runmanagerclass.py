...
class RunManager3D:
    ...
    def begin_epoch(self):
        ...
        print('my epoch count =', self.epoch_count)
    ...
    def end_epoch(self):
        ...
        loss_here = round(self.epoch_loss, 4)
        ...
        print('epoch-board', self.epoch_count, train_true_recall_here, train_true_precision_here, train_true_f1_score_here)
    ...
    def track_train_loss(self, loss_item, train_count):
        self.epoch_loss = loss_item / train_count

    def track_test_loss(self, test_epoch_loss, test_count):
        self.epoch_test_loss = test_epoch_loss / test_count

    def track_train_epoch_metrics(self, my_train_recall, my_train_precision, my_train_f1_score):
        self.true_epoch_train_recall = my_train_recall
        self.true_epoch_train_precision = my_train_precision
        self.true_epoch_train_f1_score = my_train_f1_score
